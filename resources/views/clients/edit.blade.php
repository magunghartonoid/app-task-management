        ...
        <form id="formClient">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea
                            ...
                            id="client_address"
                            name="client_address"
                            rows="3">{{ $client->client_address }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea
                            ...
                            rows="3">{{ $client->project_description }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        value="{{ $client->project_developer }}">
                ...
                <input
                    ...
                    minlength="10"
                    value="{{ $client->project_developer_phone }}">
            ...
            <div class="mb-3">
                ...
                <select
                    ...
                    <option value="On Going" {{ $client->project_status == 'On Going' ? 'selected' : '' }}> On Going </option>
                    <option value="Done" {{ $client->project_status == 'Done' ? 'selected' : '' }}>Done</option>
